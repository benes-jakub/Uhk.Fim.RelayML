...
from paths import PATH_FASTER_RCNN_DATASET_IMAGES, PATH_FASTER_RCNN_DATASET_LABELS, PATH_FASTER_RCNN_MODEL
...
def fasterrcnn_train_and_save_model():
    ...
    train_dataset = VOCDataset(PATH_FASTER_RCNN_DATASET_IMAGES, PATH_FASTER_RCNN_DATASET_LABELS, transforms=ToTensor())
    ...
    torch.save(model.state_dict(), PATH_FASTER_RCNN_MODEL)