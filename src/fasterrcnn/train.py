...
from .utils import PATH_DATASET_IMAGES, PATH_DATASET_ANNOTATIONS
...
def fasterrcnn_train_and_save_model():
    ...
    voc_dataset = VOCDataset(PATH_DATASET_IMAGES, PATH_DATASET_ANNOTATIONS, transforms=ToTensor())
    ...
    torch.save(model.state_dict(),f'./fasterrcnn/model.pt')